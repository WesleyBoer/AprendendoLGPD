...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Salvar rapidamente") action QuickSave()
            textbutton _("Carregar rapidamente") action QuickLoad()
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança diálogos / Acessa botões na interface")

    hbox:
        label _("Espaço")
        text _("Avança diálogos rapidamente")
    ...
    hbox:
        label _("Ctrl")
        text _("Matenha pressionado para pular os diálogos")

    hbox:
        label _("Tab")
        text _("Ao pressionar, ativará/desativará o pulo automático dos diálogos")

    hbox:
        label _("Page Up")
        text _("Volta os diálogos")

    hbox:
        label _("Page Down")
        text _("Avança os diálogos")
...
screen mouse_help():
    ...
    hbox:
        ...
        text _("Avança diálogos / Clica em botões")

    hbox:
        label _("Botão central (Scroll)")
        text _("Oculta a interface")
    ...
    hbox:
        label _("Rolar scroll para cima")
        text _("Volta os diálogos")

    hbox:
        label _("Rolar scroll para baixo")
        text _("Avança os diálogos")
...
screen gamepad_help():
    ...
    hbox:
        label _("Direcionais, analógicos")
        text _("Navega pela interface")
